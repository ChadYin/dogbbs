					...
					<form action="login" namespace="/" theme="simple"
						...
						<p>
							<label for="username" class="uname" data-icon="u"> Your
								email or username </label> <input type="textfield" name="user.u_email"
								id="text1" value="用户名或邮箱" onfocus="login()" />
						</p>
						<p>
							<label for="password" class="youpasswd" data-icon="p">
								Your password </label> <input name="user.u_password" type="password"
								id="password" />
						</p>
